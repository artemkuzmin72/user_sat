...
│   └── mouse.py         # Модуль отслеживания движения курсора
├── models/
...
| **Pyinput** | Трекер движения курсора |

## To Do

- Добавить эмоцию confusion 
- Маску mediapipe применить на всех картинках в датасете 
- Добавить зум камеры 
- Добавить паузу 
- Оптимизировать полноэкранный режим 
- Сделать трекер курсора отдельной интерактивной страничкой
- Добавить геймификацию к трекеру
- Убрать эмоцию fear
- Сделать браузерную версию
- Добавить график удовлетворенности
- Делать запись сессии и сохранять в мп4
- Осуществить обработку отвлечений от сессии
